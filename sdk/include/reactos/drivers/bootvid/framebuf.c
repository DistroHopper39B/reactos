...
GetFramebufferVideoData(
    _Out_ PPHYSICAL_ADDRESS BaseAddress,
    ...
    _In_ ULONG ConfigurationDataLength)
{
    ...
    if (IsNewConfigData(ConfigurationData, ConfigurationDataLength))
    {
        ...
        DPRINT1("    FbBVid: New Config data found\n");
        ...
        if (FrameBuffer)
        {
            ...
            *BufferSize  = FrameBuffer->u.Memory.Length;
            ...
            DPRINT1("**  FbBVid: Got framebuffer address: 0x%I64x - Size: %lu\n",
                    BaseAddress->QuadPart, *BufferSize);
        }
        else
        {
            /* No framebuffer base: zero it out */
            DPRINT1("**  FbBVid: No framebuffer address\n");
            ...
            (Descriptor->u.DeviceSpecificData.DataSize >= sizeof(CM_FRAMEBUF_DEVICE_DATA)))
        {
            ...
            *VideoConfigData = *VideoData;
            ...
            DPRINT1("**  FbBVid: Framebuffer information data found\n");
        }
        else
        {
            ...
            DPRINT1("**  FbBVid: Framebuffer information data NOT FOUND\n");
        }
    ...
    _Out_opt_ PULONG BusNumber)
{
    ...
    if (!NT_SUCCESS(Status) ||
        (BaseAddress->QuadPart == 0) || (*BufferSize == 0))
    {
        /* Fail if no framebuffer was provided */
        DPRINT1("No framebuffer found!\n");
        return STATUS_DEVICE_DOES_NOT_EXIST;
    ...
    _Out_opt_ PULONG BusNumber)
{
     ...
     * to be returned.
     */
    Status = FindBootDisplayFromLoaderARCTree(BaseAddress,
                                              BufferSize,
                                              VideoConfigData,
    ...
    {
        DPRINT1("Video screen dimensions not defined; use monitor resolution\n");
